...
namespace ATRGamers.ATRSeeder.Core.Configuration
{
    public static class Constants
    {
        public const string ApplicationName = "ATRSeeder";
        public const string ConfigSectionName = "ATRSeederConfig";
        ...
        public static class SettingNames
        {
            ...
            public const string GameBattlefieldFourEnabled = "GameBattlefieldFourEnabled";
            public const string GameBattlefieldHardlineEnabled = "GameBattlefieldHardlineEnabled";
        }
        ...
        public static class Games
        {
            ...
            public static GameInfo BFH = new GameInfo()
            {
                GameName = "Battlefield Hardline",
                ProcessName = "bfh",
                WindowTitle = "Battlefield Hardline",
                FaultWindowTitle = "Battlefield Hardline™",
                UrlMatch = new Regex(@"/bfh/")
            };
            ...
            public static GameInfo Default = new GameInfo()
            {
                ...
                ProcessName = "nan",
                WindowTitle = "NaN",
                FaultWindowTitle = "NaN",
                UrlMatch = new Regex(@"/NaN/")
            };
